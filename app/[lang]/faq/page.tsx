...
const faqData = {
  az: {
    ...
    items: [
      ...
      { q: "Hansı implant markalarından istifadə edirsiniz?", a: "Klinikanımızda Straumann, Bredent copaSKY, NeoBiotech, MegaGen və EBI (Evidence Implant) sistemlərindən istifadə edirik. Hər xəstə üçün sümük xüsusiyyətləri, klinik vəziyyət və protez planına uyğun olaraq optimal sistem seçilir." },
  ...
  en: {
    ...
    items: [
      ...
      { q: "Which implant brands do you use?", a: "We use Straumann, Bredent copaSKY, NeoBiotech, MegaGen and EBI (Evidence Implant) systems. The optimal system is selected based on bone characteristics, clinical situation and prosthetic plan." },
  ...
  ru: {
    ...
    items: [
      ...
      { q: "Какие бренды имплантов вы используете?", a: "Мы используем Straumann, Bredent copaSKY, NeoBiotech, MegaGen и EBI (Evidence Implant). Оптимальная система подбирается индивидуально." },
